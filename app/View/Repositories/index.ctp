...
<table class="row-fluid">
    ...
    <?php foreach($repositories as $r): ?>
        <tr>
            ...
            <td class="left-aligned"><span class="label label-<? echo ($r['Testdrive'][0]['result'] === 'Success' ? 'success' : 'important'); ?>"><?php echo (!empty($r['Testdrive']) ? $r['Testdrive'][0]['result'] : 'n/a' ); ?></span></td>
